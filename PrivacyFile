隐私条款
App重视用户的隐私。您在使用我们的产品（包含服务）时，我们可能会收集并使用您的相关信息用以提高服务质量，我们会在商业上合理的范围内尽一切可能保护您的隐私。我们建议您阅读该《隐私条款》以详细了解我们收集何种信息，如何收集信息以及如何处理或使用这些信息。 当您使用我们的产品或服务时，您同意我们在遵循该策略及当地法律的前提下收集，存储并使用您的信息。
该《隐私条款》中将涉及到一些专业性的术语，我们会用尽可能简洁的方式向您解释，以便您理解。
信息的收集与使用
我们收集并存储某些您的个人信息用于创建App帐户，并为后续服务提供必要的支持。如果您不想我们提供这些信息，可能无法注册或无法享受我们提供的某些服务，或者部分功能无法达到最佳体验。未注册用户也可以所有功能，我们不会收集未注册用户的个人信息。
我们获取的个人信息包括
...
您可以关闭“App云服务”，这样我们将不会收集与照片（或同类文件）相关的信息。但同样的，你也无法使用需要这些信息支持的功能。
您可以关闭计算机或收集的gps定位功能，这样我们将不会获得您当前的地理位置信息。您需要使用一个电子邮件地址或电话创建一个App账户，这样您才可以充分使用App的完整服务。
我们可能通过电子邮件或系统通知向你发送通知，当你不希望接收这些消息时，可以按照相关提示在设备上或应用内关闭。
您可以随时停止使用我们的服务，当您删除数据后由于电脑系统的运行和持续数据备份及存档特性，服务器中残存的副本可能会过一段时间才能清除。
公开的信息
当您使用App的产品或服务时，我们默认您已经允许并同意该条款。因此，我们不会在除以下任何情况之外与任何第三方分享您的信息，亦不会出售或出租或以其他方式分发给其他人。
我们获得您明确同意我们分享信息
由于必要的原因，如完成支付交易或付费购买App的产品，我们可能会与此行为关联的第三方服务提供商分享您的信息。这些服务提供商仅已获授权在提供服务所必需的范围内使用您的个人信息。
